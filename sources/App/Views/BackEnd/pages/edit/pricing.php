<!-- BEGIN BASE-->
	<div id="base">
		...
		<div class="section-header">
			<h2 class="text-primary">Chỉnh Sửa Pricing</h2>
		</div>
		<div class="section-body">
			...
			if (isset($_POST['submit'])){
				if ($_SESSION['role'] == 1) {
					$condition = 'name = :name, price = :price, features = :features, purchase = :purchase';
					$data = array(
					...
					if (Pricing_Model::update($condition,$data)) {
							...
							<div class="card-body">
								<form class="form-horizontal" role="form" method="post">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" name="price" value="<?php echo $item->price;?>"><div class="form-control-line"></div>
										</div>
									</div>
									<div class="form-group">
										<label for="purchase" class="col-sm-2 control-label">Purchase</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" name="purchase" value="<?php echo $item->purchase;?>"><div class="form-control-line"></div>
										</div>
									</div>
									<div class="form-group">
										<label for="features" class="col-sm-2 control-label">Features</label>
										<div class="col-sm-10">
											<textarea name="features" class="form-control" rows="2" placeholder=""><?php echo $item->features;?></textarea><div class="form-control-line"></div>
										</div>
									</div>
