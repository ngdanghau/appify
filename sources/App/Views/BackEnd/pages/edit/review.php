<!-- BEGIN BASE-->
	<div id="base">
		...
		<div class="section-header">
			<h2 class="text-primary">Chỉnh Sửa Review</h2>
		</div>
		<div class="section-body">
			...
			if (isset($_POST['submit'])){
				if ($_SESSION['role'] == 1) {
					$condition = 'name = :name, image = :image, text = :text, designation = :designation';
					$data = array(
					...
					if (Review_Model::update($condition,$data)) {
							...
							<div class="card-body">
								<form class="form-horizontal" role="form" method="post">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" name="image" value="<?php echo $item->image;?>"><div class="form-control-line"></div>
										</div>
									</div>
									<div class="form-group">
										<label for="text" class="col-sm-2 control-label">Text</label>
										<div class="col-sm-10">
											<textarea name="text" class="form-control" rows="2" placeholder=""><?php echo $item->text;?></textarea><div class="form-control-line"></div>
										</div>
									</div>
									<div class="form-group">
										<label for="designation" class="col-sm-2 control-label">Designation</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" name="designation" value="<?php echo $item->designation;?>"><div class="form-control-line"></div>
										</div>
									</div>
