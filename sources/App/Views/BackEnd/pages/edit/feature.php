<!-- BEGIN BASE-->
	<div id="base">
		...
		<div class="section-header">
			<h2 class="text-primary">Chỉnh Sửa Service</h2>
		</div>
		<div class="section-body">
			...
			if (isset($_POST['submit'])){
				if ($_SESSION['role'] == 1) {
					$condition = 'icon = :icon, title = :title, entry = :entry';
					$data = array(
					...
					if (Feature_Model::update($condition,$data)) {
							...
							<div class="card-body">
								<form class="form-horizontal" role="form" method="post">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<textarea name="entry" class="form-control" rows="2" placeholder=""><?php echo $item->entry;?></textarea><div class="form-control-line"></div>
										</div>
									</div>
