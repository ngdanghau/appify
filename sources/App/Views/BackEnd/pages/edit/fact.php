	...
	<div id="base">
		...
		<div class="section-body">
			...
			if (isset($_POST['submit'])){
				if ($_SESSION['role'] == 1) {
					$condition = 'icon = :icon, title = :title, count = :count';
					$data = array(
					...
					if (Fact_Model::update($condition,$data)) {
							...
							<div class="card-body">
								<form class="form-horizontal" role="form" method="post">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<textarea name="count" class="form-control" rows="2" placeholder=""><?php echo $item->count;?></textarea><div class="form-control-line"></div>
										</div>
									</div>
