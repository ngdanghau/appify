	...
	<div id="base">
		...
		<div class="section-body">
			...
			if (isset($_POST['submit'])){
				$condition = 'title, title_seo, description, featured, category, tags, content, timeupdate, author';
				$value = ':title, :title_seo, :description, :featured, :category, :tags, :content, :timeupdate, :author';
				$data = array(
					...
					$id = Post_Model::create($condition,$value,$data);
					if (!empty($id)) {
							...
							<div class="card-body">
								<form class="form-horizontal" role="form" method="post">
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" id="slug-source" class="form-control" name="title"><div class="form-control-line"></div>
										</div>
									</div>
									<div class="form-group">
										<label for="featured" class="col-sm-2 control-label">Hình Ảnh</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" name="featured"><div class="form-control-line"></div>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" id="slug-target" class="form-control" name="title_seo"><div class="form-control-line"></div>
										</div>
									</div>
									<div class="form-group">
										<label for="tags" class="col-sm-2 control-label">Tags</label>
										<div class="col-sm-10">
											<textarea name="tags" class="form-control" rows="2" placeholder=""></textarea><div class="form-control-line"></div>
										</div>
									</div>
									<div class="form-group">
										<label for="textarea13" class="col-sm-2 control-label">Mô tả</label>
										<div class="col-sm-10">
											<textarea name="description" class="form-control" rows="6" placeholder=""></textarea><div class="form-control-line"></div>
										</div>
									</div>
									<div class="form-group">
										<label for="content" class="col-sm-2 control-label">Nội Dung</label>
										<div class="col-sm-10">
											<textarea id="ckeditor" name="content" class="form-control" rows="2" placeholder=""></textarea><div class="form-control-line"></div>
										</div>
									</div>
