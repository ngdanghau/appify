<!-- BEGIN BASE-->
	<div id="base">
		...
		<div class="section-header">
			<h2 class="text-primary">Thêm Menu</h2>
		</div>
		<div class="section-body">
			...
			if (isset($_POST['submit'])){
				if ($_SESSION['role'] == 1) {
					$condition = 'name, hyperlink, parent_id';
					$value = ':name, :hyperlink, :parent_id';
					$data = array(
							':name' => RemoveHack($_POST['name']),
							':hyperlink' => RemoveHack($_POST['hyperlink']),
							':parent_id' => RemoveHack($_POST['parent_id'])
						);
					$id = Menu_Model::create($condition,$value,$data);
					if (!empty($id)) {
							...
							<div class="card-body">
								<form class="form-horizontal" role="form" method="post">
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" name="name" value=""><div class="form-control-line"></div>
										</div>
									</div>
									<div class="form-group">
										<label for="hyperlink" class="col-sm-2 control-label">Siêu Liên Kết</label>
										<div class="col-sm-10">
											<input type="text" class="form-control" name="hyperlink" value=""><div class="form-control-line"></div>
										</div>
									</div>
									<div class="form-group">
