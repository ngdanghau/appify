<!-- BEGIN BASE-->
	<div id="base">
		...
		<div class="section-header">
			<h2 class="text-primary">Tạo Screenshot</h2>
		</div>
		<div class="section-body">
			...
			if (isset($_POST['submit'])){
				if ($_SESSION['role'] == 1) {
					...
					$id = Screenshot_Model::create($condition,$value,$data);
					if (!empty($id)) {
							...
							<div class="card-body">
								<form class="form-horizontal" role="form" method="post">
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" name="src"><div class="form-control-line"></div>
										</div>
									</div>
									<div class="form-group">
