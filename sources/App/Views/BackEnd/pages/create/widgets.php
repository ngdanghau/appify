<!-- BEGIN BASE-->
	<div id="base">
		...
		<div class="section-header">
			<h2 class="text-primary">Tạo Widgets</h2>
		</div>
		<div class="section-body">
			...
			if (isset($_POST['submit'])){
				if ($_SESSION['role'] == 1) {
					$condition = 'name, nameid, hide';
					$value = ':name, :nameid, :hide';
					$data = array(
						':name' => RemoveHack($_POST['name']),
						':nameid' => RemoveHack($_POST['nameid']),
						':hide' => RemoveHack($_POST['hide'])
					);
					$id = Widget_Model::create($condition,$value,$data);
					if (!empty($id)) {
							...
							<div class="card-body">
								<form class="form-horizontal" role="form" method="post">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" name="nameid"><div class="form-control-line"></div>
										</div>
									</div>
									<div class="form-group">
